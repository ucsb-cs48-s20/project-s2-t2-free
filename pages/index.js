...
function HomePage(props) {
  ...
  return (
    <Layout user={user}>
      ...
      <p>
        To get started with our app, login by navigating to the top right corner
        of our home page and press our "Login" button.
      </p>
      <h2> My Schedule Page</h2>
      <p>The My Schedule page contains four main components:</p>
      <h5>1. Daily Start/End Times</h5>
      <p>
        Allows you to set global start and end times to your calendar. For
        example, you can set your default work hours from 9am to 5 pm each week.
      </p>
      <h5>2. Create New Event</h5>
      <p>
        Allows you to add events to your schedule. You can add events for
        multiple days at a time and can select start and end times from our drop
        down menu.
      </p>
      ...
      <p>
        ...
        start/end times and all events that have been entered
      </p>
      ...
      <p>
        ...
        and press "Join". If you received a unique group code, enter the code in
        the Groups Management page which will redirect you to the group page
        where you can press "Join".
      </p>
